...
public class OpenLayersObjectWrapper extends JSObjectWrapper {
    ...
    public static OpenLayersObjectWrapper narrowToOpenLayersObjectWrapper(
            JSObject element) {
     ...
     *
     * @return Events - see
     * {@link org.gwtopenmaps.openlayers.client.event.Events}, null if the
     * object does not fire events via event system.
     */
    public Events getEvents() {
        ...
        return Events.narrowToEvents(OpenLayersObjectWrapperImpl.getEvents(
                getJSObject()));
    }
     ...
     *
     * Some classes, like Layer and it's subclasses have a public id property
     * which is generally composed of the CLASS_NAME + _Nr where Nr is some
     * integer generated by OpenLayers
     *
