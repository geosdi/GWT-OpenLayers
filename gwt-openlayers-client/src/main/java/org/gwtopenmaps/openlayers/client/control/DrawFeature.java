...
public class DrawFeature extends Control {
    ...
    /**
     * Finishes the sketch without including the currently drawn point. This
     * method can be called to terminate drawing programmatically instead of
     * waiting for the user to end the sketch.
     */
