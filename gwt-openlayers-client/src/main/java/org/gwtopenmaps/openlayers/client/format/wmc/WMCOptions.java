...
public class WMCOptions extends FormatOptions {
    ...
    /**
     * Use this method to merge ... with the map or use setMapDomElementId to
     * create a new map in that dom element.
     *
     *
     * @param map - the map to merge map elements with that are created on the
     * basis of the WMC document
     */
    ...
    /**
     *
     * @param id - the dom element id where to put the map created from reading
     * a WMC document
     */
