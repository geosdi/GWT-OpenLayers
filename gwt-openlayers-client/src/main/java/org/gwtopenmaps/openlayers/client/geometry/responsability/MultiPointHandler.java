 ...
 */
class MultiPointHandler extends GWTOLGeometryHandler {

    public MultiPointHandler() {
        super.setSuccessor(new LineStringHandler());
    }
