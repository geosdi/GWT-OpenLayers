...
public class ArcGIS93Rest extends GridLayer {
     ...
     *
     * Returns: {<ArcGIS93Rest>} An exact clone of this layer
     */
     ...
     *
     * Parameters: bounds - {<Bounds>} A bounds representing the bbox for the
     * request.
     *
     ...
     * the layer div.
     *
     * Parameters: bounds - {<Bounds>} position - {<Pixel>}
     *
     * Returns: {<Image>} The added OpenLayers.Tile.Image
     */
    ...
    @Override
    protected LayerCreator<ArcGIS93Rest> getLayerCreator() {
        return new LayerCreator<ArcGIS93Rest>() {
