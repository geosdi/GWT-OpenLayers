...
public class BasicGoogleV3Example extends AbstractExample
{
    ...
    */
   public BasicGoogleV3Example(String title, String source)
   {
      super(title, source);
   }
   ...
   public void buildPanel()
   {
      ...
      contentPanel.add(new InfoPanel("<p>Note that this example is not working in this showcase. This is because the Google V2 and V3 API's conflict with each other. If you however look at the source, and create a project only containing Google V3 it should work without a problem.</b></p>"));
