...
public class AnimatedClusterStrategyTreshHoldExample extends AbstractExample {

    @Inject
    public AnimatedClusterStrategyTreshHoldExample(ShowcaseExampleStore store) {
        super("Animated cluster Strategy",
              "Demonstrates the use of the animated cluster strategy",
              new String[]{"WMS", "cluster", "animated", "treshold", "strategy", "style", "filter"}, store);
    }
    ...
    public void buildPanel() {
        ...
        contentPanel.add(new InfoPanel("<P>This example makes use of the AnimatedCluster strategy. This strategy is no part of the default OpenLayers library.</P>" +
    ...
    public String getSourceCodeURL() {
        return GWT.getModuleBaseURL() + "examples/cluster/"
                + "AnimatedClusterStrategyTreshHoldExample.txt";
    }
}
