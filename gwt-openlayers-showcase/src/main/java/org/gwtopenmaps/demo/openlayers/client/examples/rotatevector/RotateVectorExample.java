...
public class RotateVectorExample extends AbstractExample
{
    ...
    */
   public RotateVectorExample(String title, String source)
   {
      super(title, source);
   }
   ...
   public void buildPanel()
   {
      ...
      contentPanel.add(new HTML("<p>This example shows a few features rotating. There is not yet a control built that provides a tool for rotating, but the geometry.rotate method can be accessed to rotate programmatically.</p>"));
