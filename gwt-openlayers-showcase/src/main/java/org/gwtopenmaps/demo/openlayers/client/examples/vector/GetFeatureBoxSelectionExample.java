...
public class GetFeatureBoxSelectionExample extends FeatureSelectionExample {
    ...
    public GetFeatureBoxSelectionExample(ShowcaseExampleStore store) {
        super("WFS Get Feature Control Box Examples", "Demonstrates the use of WMS/WFS Box selection.",
    ...
    public void buildPanel() {
        ...
        controlFeature.addFeaturesSelectedListener(new FeaturesSelectedListener() {

            public void onFeaturesSelected(final FeaturesSelectedEvent event) {
                controlFeature.unselectAll();
                final VectorFeature[] features = event.getFeatures();

                if(select.getNumberOfFeatures() > 0) {
        ...
        controlFeature.addFeatureUnselectedListener(new FeatureUnselectedListener() {

            public void onFeatureUnselected(FeatureUnselectedListener.FeatureUnselectedEvent event) {
    ...
    protected Widget createComponent() {
        return new HTML("<p>This example shows how to use a " + "selection feature on a WMS layer.</p>" +
