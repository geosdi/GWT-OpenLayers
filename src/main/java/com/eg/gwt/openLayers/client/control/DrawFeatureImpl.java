...
class DrawFeatureImpl {
	...
	public static native JSObject createFeatureAddedCallback(FeatureAddedListener listener)/*-{
		var callback = function(obj){
			listener.@com.eg.gwt.openLayers.client.control.DrawFeature.FeatureAddedListener::onFeatureAdded(Lcom/eg/gwt/openLayers/client/util/JSObject;)(obj);
		}
		return callback;
	}-*/;
	...
	public static native JSObject create(JSObject layer, JSObject handler, FeatureAddedListener listener)/*-{
		var callback = function(obj){
			listener.@com.eg.gwt.openLayers.client.event.FeatureAddedListener::onFeatureAdded(Lcom/eg/gwt/openLayers/client/util/JSObject;)(obj);
		}
